...
function menu(){
	...
	function my_theme_enqueue_scripts() {
		...
		wp_enqueue_script( 'google-map', 'https://maps.googleapis.com/maps/api/js?key=AIzaSyCpVgq8pZBwiRHU84Rj8CQ7nwi95Dr3lKs');
		//wp_enqueue_script( 'google-map-init', get_template_directory_uri() . '/dist/bundle.js', array('google-map', 'jquery'), '0.1', true );
	...
	/* Google map API */
	/*
	acf_update_setting('google_api_key', ' AIzaSyAdbsSXw7JAcw3F6jMzGMGEEZ4N8Cb_oto');
*/

/*
function my_theme_add_scripts() {
	wp_enqueue_script( 'google-map', 'https://maps.googleapis.com/maps/api/js?key=AIzaSyAdbsSXw7JAcw3F6jMzGMGEEZ4N8Cb_oto', array(), '3', true );
...
function my_acf_google_map_api( $api ){
	...
	$api['key'] = 'AIzaSyAdbsSXw7JAcw3F6jMzGMGEEZ4N8Cb_oto';
...
//
// 	//acf_update_setting('google_api_key', 'AIzaSyAdbsSXw7JAcw3F6jMzGMGEEZ4N8Cb_oto');
// 	acf_update_setting('google_api_key', 'AIzaSyCpVgq8pZBwiRHU84Rj8CQ7nwi95Dr3lKs');
//
// }
//
...
// function my_theme_add_scripts() {
//  wp_enqueue_script( 'google-map', 'https://maps.googleapis.com/maps/api/js?key=AIzaSyCpVgq8pZBwiRHU84Rj8CQ7nwi95Dr3lKs', array(), '3', true );
//  wp_enqueue_script( 'google-map-init', get_template_directory_uri() . '/dist/bundle.js', array('google-map', 'jquery'), '0.1', true );
//
...
function my_acf_google_map_api( $api ){
 ...
 $api['key'] = 'AIzaSyCpVgq8pZBwiRHU84Rj8CQ7nwi95Dr3lKs';
